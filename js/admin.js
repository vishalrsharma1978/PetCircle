    ...
    function updateUserProfileActionState(userId, name) {
      ...
      btn.className = "no-faith-hover flex-1 py-2 rounded-xl text-base font-bold shadow-md border shadow-lg transition-all flex items-center justify-center gap-2";
      if (optionsContainer) {
    ...
    function privacyToggleRow(key, title, desc) {
      return `
        <div class="flex items-center justify-between gap-4 py-4 border-b border-gray-100 dark:border-gray-800 last:border-0">
          <div class="min-w-0">
            <p class="text-base font-bold shadow-md text-gray-900 dark:text-gray-100">${title}</p>
