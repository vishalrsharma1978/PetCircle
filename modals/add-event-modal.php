    ...
    <div
      ...
      <div
        ...
        <button id="event-modal-submit-btn" onclick="saveEventFromModal()"
          class="inline-flex items-center gap-2 px-5 py-2 bg-brand-500 hover:bg-brand-600 text-white font-bold rounded-lg shadow transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
          <svg id="event-modal-submit-spinner" class="hidden animate-spin w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
          </svg>
          <span id="event-modal-submit-label">Save Event</span>
        </button>
      </div>
    </div>
  </div>