<div id="view-public-login"
  ...
  <div id="lp-left-pane"
    ...
    <div class="flex items-center gap-3 mb-4 flex-shrink-0 relative z-10">
      ...
      <div>
        <div class="text-2xl font-bold tracking-tight text-black leading-tight" style="font-family: 'DM Serif Display'">
          PawCircle</div>
    ...
    <div class="mt-auto pt-2 relative z-10 w-full flex flex-col items-start"><!-- Pet Type Selector -->
      <div>
        <label class="block text-sm font-semibold text-black font-medium mb-1 text-xs text-gray-700">Your Pet
          Type</label>
        <div class="relative">
