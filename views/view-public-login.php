<div id="view-public-login"
    ...
    <div id="lp-left-pane"
      class="w-full lg:w-1/2 h-full max-h-[100dvh] flex flex-col p-4 sm:p-5 lg:p-6 overflow-hidden overflow-x-hidden no-scrollbar relative"
      ...
      <!-- Trailing Paws Background (from signup) -->
      ...
      <div class="flex items-center gap-3 mb-4 flex-shrink-0 relative z-10">
        ...
        <div>
          <div class="text-2xl font-bold tracking-tight text-black leading-tight"
            style="font-family: 'DM Serif Display'">PawCircle</div>
          <div class="text-[11px] font-black text-amber-500 tracking-[0.2em] uppercase">Pet Breed</div>
        </div>
        <span
      ...
      <!-- Hidden showcase -->
      <div id="public-theme-showcase" class="hidden"></div>
<div class="mt-auto pt-2 relative z-10 w-full flex flex-col items-start"><!-- Pet Type Selector -->
          <div>
            <label class="block text-sm font-semibold text-black font-medium mb-1 text-xs text-gray-700">Your Pet Type</label>
            <div class="relative">
              <select id="login-pet-type"
                class="block w-full max-w-[200px] pl-4 pr-10 py-1.5 text-xs border border-gray-300 rounded-xl focus:outline-none focus:border-transparent text-sm bg-white/90 text-gray-900 appearance-none transition-all focus-ring-dynamic"
              ...
              <i data-lucide="chevron-down"
                class="absolute right-3 top-3.5 w-4 h-4 text-gray-500 pointer-events-none"></i>
            </div>
    ...
    <div id="lp-right-pane"
      class="w-full lg:w-1/2 h-full flex flex-col items-center justify-start pt-10 sm:pt-16 pb-8 bg-white border-t lg:border-t-0 lg:border-l border-gray-100 p-6 sm:px-8 overflow-y-auto overflow-x-hidden"
      style="transition: --login-accent 0.5s ease;">

      <div class="w-full max-w-sm bg-white/96 backdrop-blur-sm rounded-3xl border border-white/75 shadow-lg p-6 sm:p-7">
        ...
        <div class="mb-8 text-center">
          <div
            ...
            <img src="assets/mascots/pawcircle-logo.svg" alt="PawCircle logo" class="w-11 h-11 object-contain" loading="eager" decoding="async" />
          </div>
          <h3 class="text-3xl font-bold text-gray-900" style="font-family: 'DM Serif Display'">Welcome back</h3>
        ...
        <form id="public-login-form" novalidate autocomplete="off" class="space-y-10">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="email" id="public-email" name="public_email" required autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false"
          ...
          <button type="submit" id="public-submit-btn"
            class="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-base font-bold shadow-md text-white transition-all hover:-translate-y-0.5 duration-500"
        ...
        <div class="mt-6 text-center">
          <button onclick="switchView('view-admin-login')"
            class="text-xs text-gray-400 hover:text-gray-600 transition-colors underline decoration-gray-300 underline-offset-4">
            Admin Portal
          </button>
        </div>
